...
class Vehical {
  constructor(name, wheels, isDeisel) {
    (this.name = name), (this.wheels = wheels), (this.isDeisel = isDeisel);
  }
  drive() {
    console.log("you can drive");
  }
  break() {
    console.log("If you want to stop car then use break");
  }
}
// const car = new Vehical("BMW",4,true);
// const bike = new Vehical("Appachi",2,true);
...
// const jason = JSON.stringify(car);
// console.log(jason);
